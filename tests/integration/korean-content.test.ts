...
import { extractTableOfContents, processMarkdown } from '@/lib/markdown'
...
const mockSearchDocuments = [
  ...
  },
  {
    ...
    title: '타입스크립트 기초',
    content:
      '타입스크립트를 사용하여 더 안전한 JavaScript 코드를 작성할 수 있습니다.',
    category: '프론트엔드',
...
describe('Korean Content Processing Integration', () => {
  ...
  test('should maintain reading flow for Korean text', () => {
    ...
    const longParagraphMatch = result.content.match(
      /한국어 콘텐츠 처리 시스템은.*?제공해야 합니다\./s
    )
