...
import { createSearchEngine, searchPosts, SearchResult } from '@/lib/search';
  ...
  const sampleSearchIndex = [
    {
      ...
      content: 'React Hooks는 함수 컴포넌트에서 상태를 관리할 수 있게 해주는 기능입니다. useState, useEffect 등이 있습니다.',
      category: 'frontend',
    ...
    },
    {
      ...
      content: 'TypeScript는 정적 타입을 제공하는 JavaScript의 상위집합입니다. 타입 안정성을 보장합니다.',
      category: 'frontend',
    ...
    },
    {
      ...
      content: 'Next.js 애플리케이션을 Vercel이나 기타 플랫폼에 배포하는 방법을 알아봅시다.',
      category: 'deployment',
