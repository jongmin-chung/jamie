                ...
                <div className="flex flex-col gap-2">
                  <a
                    ...
                    className={`text-left py-1.5 hover:text-yellow-500 transition-colors ${
                      activeHeading === 'react-hooks-완전-가이드' ? 'text-yellow-500 font-medium' : 'text-gray-700'
                    }`}
                    onClick={(e) => {
                      e.preventDefault()
                      document.getElementById('react-hooks-완전-가이드')?.scrollIntoView({
                        behavior: 'smooth',
                        block: 'start',
                      })
                    }}
                  ...
                  <a
                    href="#usestate-hook"
                    className={`text-left py-1.5 hover:text-yellow-500 transition-colors ${
                      activeHeading === 'usestate-hook' ? 'text-yellow-500 font-medium' : 'text-gray-700'
                    }`}
                    onClick={(e) => {
                      e.preventDefault()
                  ...
                  <a
                    href="#useeffect-hook"
                    className={`text-left py-1.5 hover:text-yellow-500 transition-colors ${
                      activeHeading === 'useeffect-hook' ? 'text-yellow-500 font-medium' : 'text-gray-700'
                    }`}
                    onClick={(e) => {
                      e.preventDefault()
                      document.getElementById('useeffect-hook')?.scrollIntoView({
                        behavior: 'smooth',
                        block: 'start',
                      })
                    }}
                  ...
                  <a
                    href="#커스텀-hook-만들기"
                    className={`text-left py-1.5 hover:text-yellow-500 transition-colors ${
                      activeHeading === '커스텀-hook-만들기' ? 'text-yellow-500 font-medium' : 'text-gray-700'
                    }`}
                    onClick={(e) => {
                      e.preventDefault()
                      document.getElementById('커스텀-hook-만들기')?.scrollIntoView({
                        behavior: 'smooth',
                        block: 'start',
                      })
                    }}
                  ...
                  <a
                    href="#주의사항"
                    className={`text-left py-1.5 hover:text-yellow-500 transition-colors ${
                      activeHeading === '주의사항' ? 'text-yellow-500 font-medium' : 'text-gray-700'
                    }`}
                    onClick={(e) => {
                      e.preventDefault()
                  ...
                  <a
                    href="#결론"
                    className={`text-left py-1.5 hover:text-yellow-500 transition-colors ${
                      activeHeading === '결론' ? 'text-yellow-500 font-medium' : 'text-gray-700'
                    }`}
                    onClick={(e) => {
                      e.preventDefault()
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link href="/blog/typescript-basics" className="block">
              <article className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                ...
                />
                <div className="p-5">
                  <h3 className="text-xl font-semibold mb-2">TypeScript 기초 완벽 정리</h3>
                  <p className="text-gray-600 mb-3">TypeScript의 기본 개념부터 실무 활용법까지, 초보자도 쉽게 이해할 수 있는 완벽한 가이드입니다.</p>
            ...
            <Link href="/blog/javascript-es6-features" className="block">
              <article className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                ...
                />
                <div className="p-5">
                  <h3 className="text-xl font-semibold mb-2">JavaScript ES6+ 주요 기능 정리</h3>
                  <p className="text-gray-600 mb-3">ES6부터 최신 JavaScript까지, 현대 JavaScript 개발에 필수인 기능들을 정리했습니다.</p>
            ...
            <Link href="/blog/web-performance-optimization" className="block">
              <article className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                ...
                />
                <div className="p-5">
                  <h3 className="text-xl font-semibold mb-2">웹 성능 최적화 실전 가이드</h3>
                  <p className="text-gray-600 mb-3">실제 웹사이트 성능을 개선하는 구체적인 방법들을 살펴봅시다. Core Web Vitals부터 실무 최적화 기법까지.</p>
